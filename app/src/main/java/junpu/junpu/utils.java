...
public class utils {
    ...
    public static String[][] achievementsList = {
            ...
            {"Destroyer", "Get 100 wins"},
            {"Hunter", "Kill 5 different opponents"},
            {"Climbing the Ladder", "Get 10 wins"},
            {"Space Pirate", "Get 50 wins"},
            {"Top of the World", "Get 25 wins"},
            {"Leveling Up", "Get to Level 15"},
            {"Hobbyist", "Log 500 biking sessions"},
            {"Better Safe than Sorry", "Log 250 biking safe sessions"},
            ...
            {"Masterful", "Have a win/loss ratio above 60% with more than 50 battles"},
